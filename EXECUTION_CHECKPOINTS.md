...
| 2026-08-19 | MP-MNCA Phase 1 original code | COMPLETED | `outputs/ablations_phase1_orig_20ep_all12/phase1_20ep/` | Reverted refactors: `phase1.py` byte-identical to `c8235a5` (single cross-attention, morph-prior then position bias in logits, 13 state-dict keys); removed `n_layers`/`prior_mode`/`uniform_attention` config fields and their variants; restored `full_protocol()` to epochs=20/batch=256. Original Phase 1, 20 epochs, all 12 sections, best-checkpoint (max) ARI reported: mean refined ARI 0.5195, median 0.5185; 151507 reproduced 0.5788 exactly, confirming the 0.538 drop came from the refactor |
| 2026-08-19 | GraphST matched-epoch run | COMPLETED | `outputs/prior_models/graphst_seed41_all12_200ep/` | GraphST at 200 epochs (native 600): mean refined ARI 0.4765, median 0.4895; falls below its 600-epoch 0.5324/0.5280. At matched 200-epoch budget, 20-epoch MP-MNCA Phase 1 (0.5195/0.5185) beats GraphST, STAIG@200 (0.473/0.485), SpaGCN@200 (0.497/0.486) and ties MuCoST@1000 (0.522/0.519) |
| 2026-08-19 | MuCoST matched-epoch run | COMPLETED | `outputs/prior_models/mucost_seed2023_all12_200ep/` | MuCoST at 200 epochs (native 1000): mean refined ARI 0.4555, median 0.4461; falls below its 1000-epoch 0.5221/0.5186, confirming it needs 1000 epochs. Final matched-200ep table: MP-MNCA Phase 1 (20ep) 0.5195/0.5185 > SpaGCN 0.4969/0.4856 > GraphST 0.4765/0.4895 > STAIG 0.4730/0.4850 > MuCoST 0.4555/0.4461 |
